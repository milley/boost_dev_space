...
int main(int argc, char **argv)
{
    ...
    { // Parent process
        ...
        // Create an object of MyType initilized to {0.0, 0}
        MyType *instance = segment.construct<MyType>("MyType instance") // name of the object
                           (0.0, 0);                                    // ctor first argument

        // Create an array of 10 elements of MyType initialized to {0.0, 0}
        MyType *array = segment.construct<MyType>("MyType array") // name of the object
                            [10]                                  // number of elements
                        (0.0, 0);                                 // same two ctor arguments for all object
        ...
        MyType *array_it = segment.construct_it<MyType>("MyType array from it") // name of object
        ...
        // Check child has destoryed all objects
    ...
    else
    {
        ...
        // Find the array construted from iterators
